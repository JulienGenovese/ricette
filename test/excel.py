...
class TestRecipeRepository:
    ...
    def filepath(self):
        ...
        return "dati/ricette/Cucina ottimizzata.xlsx"
    ...
    def test_initialization(self, repository):
        """Test che il repository sia inizializzato correttamente"""
        assert repository._filepath == "dati/ricette/Cucina ottimizzata.xlsx"
        assert len(repository.CATEGORIES) == 4
